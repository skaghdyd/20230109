...
<%-- 				<p><%=product.getProductId() %> --%>
				<img src="/_20230109/min_jsp/up<%=product.getFileRealName() %>"class="rounded" width="250px" height="300px" style="margin: 0; padding: 0;"  >
...
<%-- 				<p><%=product.getUnitsInSock() %> --%>
				...
				<p><a href="cart.jsp" class="cartBtn">장바구니&raquo;</a><p>
			</div>
			<%
				}
			%>
